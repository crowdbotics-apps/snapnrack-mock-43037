...
export const api_v1_project_info_list = createAsyncThunk(
  "project_infos/api_v1_project_info_list",
  async payload => {
    const response = await apiService.api_v1_project_info_list(payload)
    return response.data
  }
)
export const api_v1_project_info_create = createAsyncThunk(
  "project_infos/api_v1_project_info_create",
  async payload => {
    const response = await apiService.api_v1_project_info_create(payload)
    return response.data
  }
)
export const api_v1_project_info_retrieve = createAsyncThunk(
  "project_infos/api_v1_project_info_retrieve",
  async payload => {
    const response = await apiService.api_v1_project_info_retrieve(payload)
    return response.data
  }
)
export const api_v1_project_info_update = createAsyncThunk(
  "project_infos/api_v1_project_info_update",
  async payload => {
    const response = await apiService.api_v1_project_info_update(payload)
    return response.data
  }
)
export const api_v1_project_info_partial_update = createAsyncThunk(
  "project_infos/api_v1_project_info_partial_update",
  async payload => {
    const response = await apiService.api_v1_project_info_partial_update(
      payload
    )
    return response.data
  }
)
export const api_v1_project_info_destroy = createAsyncThunk(
  "project_infos/api_v1_project_info_destroy",
  async payload => {
