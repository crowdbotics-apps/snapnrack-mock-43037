"""
Django settings for snapnrack_mock_43037 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "project_info"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'snapnrack_mock_43037.urls'
...
WSGI_APPLICATION = 'snapnrack_mock_43037.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snapnrack_mock_43037 API",
    "DESCRIPTION": "API documentation for snapnrack_mock_43037 App",
    "VERSION": "v1",
}
